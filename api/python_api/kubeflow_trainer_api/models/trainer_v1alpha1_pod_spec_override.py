...
=======
    ...
    target_jobs: List[TrainerV1alpha1PodSpecOverrideTargetJob] = Field(description="targetJobs is the list of replicated jobs in the training runtime template to apply the overrides.", alias="targetJobs")
