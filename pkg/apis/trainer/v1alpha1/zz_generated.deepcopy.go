...
func (in *CheckpointInfo) DeepCopyInto(out *CheckpointInfo) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CheckpointInfo.
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CheckpointPersistentVolumeConfig) DeepCopyInto(out *CheckpointPersistentVolumeConfig) {
	*out = *in
	if in.MountPath != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CheckpointPersistentVolumeConfig.
func (in *CheckpointPersistentVolumeConfig) DeepCopy() *CheckpointPersistentVolumeConfig {
	if in == nil {
		return nil
	}
	out := new(CheckpointPersistentVolumeConfig)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CheckpointStorage) DeepCopyInto(out *CheckpointStorage) {
	*out = *in
	if in.SecretRef != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CheckpointStorage.
func (in *CheckpointStorage) DeepCopy() *CheckpointStorage {
	if in == nil {
		return nil
	}
	out := new(CheckpointStorage)
	in.DeepCopyInto(out)
	return out
}
...
func (in *CheckpointingConfig) DeepCopyInto(out *CheckpointingConfig) {
	*out = *in
	...
	if in.ResumeFromCheckpoint != nil {
		in, out := &in.ResumeFromCheckpoint, &out.ResumeFromCheckpoint
		*out = new(bool)
		**out = **in
	}
	if in.Env != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CheckpointingStatus) DeepCopyInto(out *CheckpointingStatus) {
	*out = *in
	...
	if in.LatestCheckpointTime != nil {
		in, out := &in.LatestCheckpointTime, &out.LatestCheckpointTime
		*out = (*in).DeepCopy()
	}
	if in.LatestCheckpointSize != nil {
		in, out := &in.LatestCheckpointSize, &out.LatestCheckpointSize
		*out = new(int64)
		**out = **in
	}
	if in.AvailableCheckpoints != nil {
		in, out := &in.AvailableCheckpoints, &out.AvailableCheckpoints
		*out = make([]CheckpointInfo, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CheckpointingStatus.
func (in *CheckpointingStatus) DeepCopy() *CheckpointingStatus {
	if in == nil {
		return nil
	}
	out := new(CheckpointingStatus)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TrainingProgress) DeepCopyInto(out *TrainingProgress) {
	*out = *in
	if in.Epoch != nil {
		in, out := &in.Epoch, &out.Epoch
		*out = new(int32)
	...
	if in.TotalEpochs != nil {
		in, out := &in.TotalEpochs, &out.TotalEpochs
		*out = new(int32)
		**out = **in
	}
	if in.Step != nil {
	...
	if in.ValidationLoss != nil {
		in, out := &in.ValidationLoss, &out.ValidationLoss
		*out = new(string)
		**out = **in
	}
	if in.ValidationAccuracy != nil {
		in, out := &in.ValidationAccuracy, &out.ValidationAccuracy
		*out = new(string)
		**out = **in
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TrainingProgress.
func (in *TrainingProgress) DeepCopy() *TrainingProgress {
	if in == nil {
		return nil
	}
	out := new(TrainingProgress)
